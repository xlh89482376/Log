...
import com.zhidao.logcat.adapter.LogRecordsListAdapter;
import com.zhidao.logcat.adapter.LogcatViewerListAdapter;
...
public class LogcatViewerFloatingView extends StandOutWindow {
    ...
    //Service
    private com.zhidao.logcat.service.ILogcatViewerService mLogcatViewerService;

    //Service connection
    private final ServiceConnection mLogcatViewerServiceConnection = new ServiceConnection() {
    ...
    public Intent getPersistentNotificationIntent(int id) {
        return StandOutWindow.getShowIntent(this, com.zhidao.logcat.service.LogcatViewerFloatingView.class, id);
    }
    ...
    private void setupBottomBarView(final View rootView){
        //Pause button
        rootView.findViewById(R.id.pause).setOnClickListener(view -> {
            pauseLogging();
        ...
        //Play button
        rootView.findViewById(R.id.play).setOnClickListener(view -> {
            resumeLogging();
            view.setVisibility(View.GONE);
        ...
        rootView.findViewById(R.id.record).setOnClickListener(view -> {
            view.setVisibility(View.GONE);
        ...
        rootView.findViewById(R.id.recordOn).setOnClickListener(view -> {
            view.setVisibility(View.GONE);
        ...
        rootView.findViewById(R.id.btnRecordList).setOnClickListener(view -> {
        ...
        rootView.findViewById(R.id.find).setOnClickListener(view -> {
        ...
        rootView.findViewById(R.id.btnPriorityLevel).setOnClickListener(view -> {
...
//        rootView.findViewById(wei.mark.standout.R.id.title)
    ...
    private void setupRecordListView() {
        mRecordsListView.setOnItemClickListener((adapterView, view, i, l) -> {
        ...
        //'Back' button
        mRecordsBottombarLayout.findViewById(R.id.btnBack).setOnClickListener(view -> {
        ...
        //'Select All' button
        mRecordsBottombarLayout.findViewById(R.id.btnSelectAll).setOnClickListener(view -> {
        ...
        //'Delete' button
        mRecordsBottombarLayout.findViewById(R.id.btnDelete).setOnClickListener(view -> {
        ...
        //'Share' button
        mRecordsBottombarLayout.findViewById(R.id.btnShare).setOnClickListener(view -> shareRecordedLogFiles());
    }
    /**
    ...
    private void setupFilterTextView(final View rootView){
        rootView.findViewById(R.id.btnLogFilter).setOnClickListener(view -> {
    ...
    private  void setupPriorityLevelView(){
        mPriorityLevelRadioGroup.setOnCheckedChangeListener((radioGroup, checkedId) -> {
    ...
    private void shareRecordedLogFiles() {
        ...
        emailIntent.setData(Uri.parse("mailto:")).putExtra(Intent.EXTRA_SUBJECT, "[" + getAppName() + "] Logcat Logs");
