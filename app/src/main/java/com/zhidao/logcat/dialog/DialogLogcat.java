...
public class DialogLogcat extends Dialog {
    ...
    public DialogLogcat(@NonNull Context context, int themeResId) {
        this(context, true, null);
    }

    public DialogLogcat(@NonNull Context context, boolean cancelable, @Nullable OnCancelListener cancelListener) {
...
//                    toast("请输入logcat名称");
                    Toast.makeText(context, "请输入logcat名称", Toast.LENGTH_LONG).show();
                }

                if (!logName.isEmpty() && mOnCommitListener != null) {
